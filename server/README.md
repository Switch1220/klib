...
[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/Switch1220/klib/tree/master/LICENSE)
[![Build Status](https://github.com/Switch1220/klib/workflows/build/badge.svg)](https://github.com/Switch1220/klib/actions?query=workflow%3Abuild)
...
| https://github.com/Switch1220/klib | Your repository URL
...
```bash
# CLONE REPOSITORY
git clone https://github.com/Switch1220/klib
cd backend
...
[`@samchon/backend`](https://github.com/Switch1220/klib) provides SDK (Software Development Kit) for convenience.
...
### 4.2. Directories
  ...
  - [src/](src/): TypeScript Source directory
    - [src/api/](src/api/): Client SDK that would be published to the `@kliber-api`
