...
## Outline
[`@kliber`](https://github.com/Switch1220/klib) provides SDK (Software Development Kit) for convenience.

For the client developers who are connecting to this backend server, [`@kliber`](https://github.com/Switch1220/klib) provides not API documents like the Swagger, but provides the API interaction library, one of the typical SDK (Software Development Kit) for the convenience.
...
## Usage
Import the `@kliber-api` and enjoy the auto-completion.
